...
# Verb Dictionary
verb_dict = pd.read_json('data/json data/Tagalog to Ilokano/verb_dict.json')

# Adjective Dictionary
adj_dict = pd.read_json('data/json data/Tagalog to Ilokano/adj_dict.json')

# Tagalog to Ilokano Language Model Dictionary
dict_il_tl_lm = pd.read_json('data/json data/Ilokano to Tagalog/Example-Based/Language Model/dict_il_tl_lang_mod.json')

# Tagalog and Ilokano Famous Phrases
f_phrases = pd.read_csv('data/csv data/f_phrases.csv')
...
dict_sw = pd.read_json('data/json data/Ilokano to Tagalog/Example-Based/dict_il_sw.json')
dict_vb = pd.read_json('data/json data/Ilokano to Tagalog/Example-Based/dict_il_vb.json')
dict_nn = pd.read_json('data/json data/Ilokano to Tagalog/Example-Based/dict_il_nn.json')
dict_jj = pd.read_json('data/json data/Ilokano to Tagalog/Example-Based/dict_il_jj.json')
dict_rb = pd.read_json('data/json data/Ilokano to Tagalog/Example-Based/dict_il_rb.json')
dict_cc = pd.read_json('data/json data/Ilokano to Tagalog/Example-Based/dict_il_cc.json')
dict_pr = pd.read_json('data/json data/Ilokano to Tagalog/Example-Based/dict_il_pr.json')
dict_dt = pd.read_json('data/json data/Ilokano to Tagalog/Example-Based/dict_il_dt.json')
